...
controllerMovie.editarPelicula = async(req = request, res = response) => {
    let id = req.params.id;
    const movieToEdit = await db.Movies.findByPk(id);
    console.log(movieToEdit);
    return res.render('editar-pelicula', { movie: movieToEdit })
}
